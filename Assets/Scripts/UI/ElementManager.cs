...
public class ElementManager : MonoBehaviour
{
    ...
    public static void DequeueElement(GameObject element)
    {
        ...
        //else
        //{
        //    // Remove element manually if it's not at the front
        //    Queue<GameObject> tempQueue = new Queue<GameObject>();
        //    while (singletonInstance.elementQueue.Count > 0)
        //    {
        //        GameObject dequeued = singletonInstance.elementQueue.Dequeue();
        //        if (dequeued != element)
        //        {
        //            tempQueue.Enqueue(dequeued);
        //        }
        //    }
        //    singletonInstance.elementQueue = tempQueue;
        //    singletonInstance.ShowHeadElement(); // Update after modification
        //}
    }
